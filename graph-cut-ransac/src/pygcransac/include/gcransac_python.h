...
int findFundamentalMatrixTwoAC_(
	// The 2D-2D point correspondences
	std::vector<double>& correspondences,
	// The probabilities for each 3D-3D point correspondence if available
	std::vector<double> &point_probabilities,
...
// A method for estimating a fundamental matrix given 2D-2D correspondences
int findFundamentalMatrixPT5D3_(
	// The 2D-2D point correspondences
	std::vector<double>& correspondences,
	// The probabilities for each 3D-3D point correspondence if available
	std::vector<double> &point_probabilities,
...
int findHomographySIFT_(
	...
	// Ours
	std::vector<Eigen::Matrix3d> solver_homography_one_sift_ours(pybind11::array_t<double> &correspondences_);
	std::vector<Eigen::Matrix3d> solver_homography_two_sift_ours(pybind11::array_t<double> &correspondences_);

	// Baselines
	std::vector<Eigen::Matrix3d> solver_homography_one_sift_arxiv(pybind11::array_t<double> &correspondences_);
	std::vector<Eigen::Matrix3d> solver_homography_two_affine(pybind11::array_t<double> &correspondences_);
	std::vector<Eigen::Matrix3d> solver_homography_two_sift(pybind11::array_t<double> &correspondences_);
	std::vector<Eigen::Matrix3d> solver_homography_four_point(pybind11::array_t<double> &correspondences_);
